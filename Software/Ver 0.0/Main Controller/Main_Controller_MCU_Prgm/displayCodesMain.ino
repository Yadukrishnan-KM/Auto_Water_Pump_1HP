void lcdRefresh(){
 ...
 //********************************************************************************************* MENU SCREEN **************************************************************************************
   ...
   if(mainmenuSelectCaseNo == 10) mainmenuSelectCaseNo = 1;
   if(buttonValue == 1) mainmenuSelectCaseNo--;
   if(mainmenuSelectCaseNo == 0) mainmenuSelectCaseNo = 9;
  ...
  //********************************************************************************************* ALARM SCREEN **************************************************************************************
   ...
   if(alarmSelectionCaseNo == 7) alarmSelectionCaseNo = 1;
   if(buttonValue == 1) alarmSelectionCaseNo--;
   if(alarmSelectionCaseNo == 0) alarmSelectionCaseNo = 6;
   if(buttonValue != 0) menuTimeoutPreviousMillis = menuTimeoutCurrentMillis; // to restart timeout counter if button is pressed            
